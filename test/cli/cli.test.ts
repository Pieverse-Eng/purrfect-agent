...
describe("parseArgs: argument parsing", () => {
  ...
  it("'onboard' alone returns command with no name or chain", () => {
    expect(parseArgs(["node", "purrfect", "onboard"])).toEqual({
      command: "onboard",
      agentName: undefined,
      chainType: undefined,
    });
  ...
  it("'onboard <name>' captures the positional name", () => {
    expect(parseArgs(["node", "purrfect", "onboard", "my-agent"])).toEqual({
      command: "onboard",
      agentName: "my-agent",
      chainType: undefined,
    });
  ...
  it("'onboard <name> --chain polygon' captures both", () => {
    expect(parseArgs(["node", "purrfect", "onboard", "my-agent", "--chain", "polygon"])).toEqual({
      command: "onboard",
      agentName: "my-agent",
      chainType: "polygon",
    });
